                                    ...
                                    <form role="form"  method="post" action="store.php" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-sm-6">                                               
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="mobile_number" type="number" placeholder="Type Mobile Number">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control" rows="5" id="textArea" placeholder="Type Reveiw"></textarea><br>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
